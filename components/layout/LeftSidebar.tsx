  ...
  return (
    <aside className="w-[240px] flex-shrink-0 hidden lg:block">
      <nav className="sticky top-20 space-y-1.5">
        ...
        {!session && (
          <div className="mt-4 p-4 rounded-xl bg-surface-alt">
            <p className="text-xs text-muted mb-2">登录后解锁更多功能</p>
            <Link
              href="/login"
              className="block text-center text-sm font-medium bg-accent text-white py-2 rounded-lg hover:bg-accent-hover transition-colors"
            >
              立即登录
            </Link>
          </div>
