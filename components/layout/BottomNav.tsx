...
export default function BottomNav() {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200/80 bg-white/95 backdrop-blur lg:hidden">
      ...
      {publishOpen && (
        <Sheet onClose={() => setPublishOpen(false)}>
          ...
          <p className="mt-1 text-sm text-slate-500">资料卡用于推荐页展示自己，动态用于信息流分享事情。</p>
          <div className="mt-5 grid gap-3">
            ...
            >
              <p className="text-base font-black text-slate-900">发动态</p>
